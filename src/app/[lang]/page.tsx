  ...
  return (
    <main>
      <section
        ...
        style={{ padding: '80px clamp(24px,8vw,120px) 80px' }}
      >
        <div className="absolute inset-0 mesh-grid pointer-events-none" />
        <div className="blob" style={{ width: 520, height: 420, right: -80, top: -60, background: 'radial-gradient(ellipse, rgba(124,77,255,.22), transparent 70%)' }} />
        <div className="blob" style={{ width: 380, height: 320, left: -40, bottom: 80, background: 'radial-gradient(ellipse, rgba(0,229,255,.14), transparent 70%)', animationDelay: '-5s' }} />
        ...
        <div ref={heroRef} className="relative z-10 flex flex-col-reverse items-center gap-10 w-full md:flex-row md:justify-between md:gap-[60px]">
          <div className="max-w-[700px]">
            ...
            <div className="flex flex-wrap gap-3.5 hero-cta">
              <Button href="#about">{hero.cta.primary}</Button>
