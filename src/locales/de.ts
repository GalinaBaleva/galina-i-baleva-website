export const de = {
  nav: {
    links: [
      ...
      { section: 'certificates', label: 'Zertifikate' },
  ...
  contact: {
    ...
    desc: 'Du hast ein Projekt im Kopf? Ich freue mich auf deine Nachricht und melde mich innerhalb von 24 Stunden.',
    email: { label: 'E-Mail' },
    location: { label: 'Standort', value: 'Wien, Österreich' },
  },
  form: {
    name: 'Name',
  ...
  certificates: {
    ...
    sub: 'Offiziell anerkannte Qualifikationen von führenden Organisationen.',
    issued: 'Ausgestellt',
    period: 'Zeitraum',
    issuer: 'Aussteller',
    view: 'Ansehen',
  ...
  footer: {
    copy: '© 2025 Galina Baleva. Alle Rechte vorbehalten.',
    top: '↑ Nach oben',
  },
}
