export const ru = {
  ...
  contact: {
    ...
    desc: 'Есть идея проекта? Буду рада услышать о нём. Отвечаю в течение 24 часов.',
    email: { label: 'Эл. почта' },
    location: { label: 'Местоположение', value: 'Вена, Австрия' },
  },
  form: {
    name: 'Имя',
    ...
    subject: 'Тема',
    subjectPlaceholder: 'Запрос по проекту',
    message: 'Сообщение',
  ...
  certificates: {
    ...
    sub: 'Официально признанные квалификации от ведущих организаций.',
    issued: 'Выдан',
    period: 'Период',
    issuer: 'Источник',
    view: 'Просмотр',
  ...
  footer: {
    copy: '© 2025 Галина Балева. Все права защищены.',
    top: '↑ Наверх',
  },
}
