export const bg = {
  ...
  contact: {
    label: 'Контакт',
    title: 'Нека работим заедно',
    desc: 'Имате проект? Ще се радвам да чуя повече. Отговарям в рамките на 24 часа.',
    email: { label: 'Имейл' },
    location: { label: 'Локация', value: 'Виена, Австрия' },
  },
  form: {
    name: 'Имена',
    ...
    subject: 'Тема',
    subjectPlaceholder: 'Запитване за проект',
    message: 'Съобщение',
  ...
  certificates: {
    label: 'Сертификати',
    title: 'Моите сертификати',
    sub: 'Официално признати квалификации от водещи организации.',
    issued: 'Издаден',
    period: 'Период',
    issuer: 'Издател',
    view: 'Преглед',
  ...
  footer: {
    copy: '© 2025 Галина Балева. Всички права запазени.',
    top: '↑ Нагоре',
  },
}
